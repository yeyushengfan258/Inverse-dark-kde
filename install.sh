...
install() {
  ...
  [[ -d ${SCHEMES_DIR}/Inverse-dark.colors ]] && rm -r ${SCHEMES_DIR}/Inverse-dark.colors
  ...
  [[ ${color} == '' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/InverseDark.colors                                    ${SCHEMES_DIR} && \
  cp -ur ${SRC_DIR}/color-schemes/InverseDark.colors                                    ${PLASMA_DIR}/${name}/colors

  [[ ${color} == '-light' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/InverseDark.colors                               ${SCHEMES_DIR}
}

echo "Installing 'Inverse-dark kde themes'..."
